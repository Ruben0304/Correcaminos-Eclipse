...
public class Secretaria {
    ...
    public ArrayList<Estudiante> registrarEstudiantes() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("./datos/estudiantes.json"))) {
    ...
    public void registrarLicenciasEstudiantes() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("./datos/solicitudes.json"))) {
