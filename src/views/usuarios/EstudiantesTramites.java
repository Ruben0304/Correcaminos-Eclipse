...
public class EstudiantesTramites{
    ...
    private EstudiantesTramites() {}
    
    public static EstudiantesTramites getVista() {
        if (instance == null) {
            instance = new EstudiantesTramites();
        }
        return instance;
    }
	...
	public JPanel getPanel_lateral() {
		if (panel_lateral == null) {
			...
			btnSolicitarLicencia.setEnabled(false);
			...
			btnSolicitarLicencia.setBackground(Color.WHITE);
