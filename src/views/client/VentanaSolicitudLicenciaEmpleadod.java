...
public class VentanaSolicitudLicenciaEmpleadod{
	private JPanel panel_lateral;
    private JLabel label_3;
	private JLabel lblInicio;
    private static VentanaSolicitudLicenciaEmpleadod instance = null;
    ...
    private VentanaSolicitudLicenciaEmpleadod() {}
    
    public static VentanaSolicitudLicenciaEmpleadod getVista() {
        if (instance == null) {
            instance = new VentanaSolicitudLicenciaEmpleadod();
        }
        return instance;
    }
