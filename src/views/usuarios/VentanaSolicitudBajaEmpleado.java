...
public class VentanaSolicitudBajaEmpleado{
	private JPanel panel_lateral;
    private JLabel label_3;
	private JLabel lblInicio;
    private static VentanaSolicitudBajaEmpleado instance = null;
    ...
    private VentanaSolicitudBajaEmpleado() {}
    
    public static VentanaSolicitudBajaEmpleado getVista() {
        if (instance == null) {
            instance = new VentanaSolicitudBajaEmpleado();
        }
        return instance;
    }
	...
	public JPanel getPanel_lateral() {
		if (panel_lateral == null) {
			...
			btnSolicitarBaja.setBounds(418, 576, 164, 68);
