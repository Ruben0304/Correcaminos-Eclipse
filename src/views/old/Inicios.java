...
public class Inicios extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Inicios(Usuario usuarioAutenticado,Boolean estudianteSolicitaLicencia) {
		setBounds(100, 100, 672, 457);
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Inicios.class.getResource("/img/correcamino.png")));
		...
		contentPane = new JPanel() {
			public void paintComponent(Graphics g) {
				Image img = Toolkit.getDefaultToolkit().getImage(Inicios.class.getResource("/img/contract.jpg"));
